  ...
  return (
    <div className="min-h-screen px-96 flex flex-col items-center justify-center">
      ...
      <div className="w-full flex items-center justify-between md:justify-center">
        ...
        className="w-[300ox] lg:-[200px] md:hidden"/>
        <div className=" relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify">
            ...
            <a href="/Gary_Meledath_Resume.pdf" className="w-max flex items-center gap-x-2 mt-6 rounded-full border border-gray-300 bg-red-400 px-3 py-2 font-medium text-white hover:bg-red-500 transition-colors" download="">
